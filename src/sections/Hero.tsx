      ...
      <div className="container">
        <div className="md:flex items-center">
          ...
          <div className="mt-20 md:mt-0 md:h-[468px] md:flex-1 relative">
            ...
            <Image src={cylinderImage} alt="Image" width={220} height={220} className="hidden md:block -top-8 -left-32 md:absolute"/>
            <Image src={noodleImage} alt="Image" width={220} className="hidden lg:block absolute top-[524px] left-[448px] rotate-[360deg]"/>
          </div>
        </div>
      </div>
    </section>
